...
import { Upload, Camera, Sparkles, AlertCircle, RefreshCw, Key } from 'lucide-react';
  ...
  return (
      ...
      footer={
        <>
          ...
          <button
            ...
            className="flex items-center space-x-1.5 px-5 py-2 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-bold text-xs shadow-md transition-all disabled:opacity-50 active:scale-95"
          >
            {loading ? (
              <>
    ...
    >
      <div className="space-y-4">
        ...
        {/* Upload Dropzone */}
        <div className="relative border-2 border-dashed border-slate-700 hover:border-amber-400 rounded-xl p-4 sm:p-5 text-center transition-colors bg-slate-950/50">
          {selectedImage ? (
            <div className="space-y-3">
              <img
                src={selectedImage}
                alt="Jewelry Tag Preview"
                className="max-h-40 sm:max-h-48 mx-auto rounded-lg border border-slate-700 object-contain"
              />
              <button
                type="button"
            ...
            <div className="flex flex-col items-center justify-center space-y-2.5 py-2">
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 pt-1">
                ...
                <label className="cursor-pointer flex items-center space-x-1.5 px-3 py-1.5 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 text-amber-300 font-medium text-xs transition-colors">
